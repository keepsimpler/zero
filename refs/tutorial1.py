...
from zero.models import LinkFCContainer 
...
net = LinkFCContainer(wide_of_layers=wide_of_layers, act_fn=act_fn, batch_normalization=False)
...
for key, value in grad_inputs.items():
    print(value[0].shape)
